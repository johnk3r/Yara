rule Ransom_EXX_BR_Target {
   meta:
      description = "Detects EXX variants with targets in the BR"
      description = "@Vitalis|@StrangerealIntel"		
      author= "johnk3r"
   strings:
      ...
      $str1 = "ransomware.c" nocase
      $str2 = "cryptor.c" nocase
      $str3 = "logic.c" nocase
      $str4 = "enum_files.c" nocase
      $str5 = "aes.c" nocase
      $str6 = "rsa.c" nocase
      $str7 = "crtstuff.c" nocase
      $str8 = "mbedtls" nocase
      //seq main
  ...
  condition:
     uint16(0) == 0x457f and filesize > 80KB and 2 of ($dbg*) and 2 of ($lib*) and 1 of ($seq*) and 4 of ($str*)
}
